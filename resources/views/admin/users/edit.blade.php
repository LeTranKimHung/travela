...
<head>
    ...
    <title>Sửa tài khoản - Travel Admin</title>
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select name="role" class="form-select">
                                        <option value="u" {{ $user->role === 'u' ? 'selected' : '' }}>Người dùng</option>
                                ...
                                <div class="col-12 mt-4">
                                    <button type="submit" class="btn btn-success px-5 py-2"><i class="fas fa-check me-2"></i> Cập nhật tài khoản</button>
                                </div>
                            </div>
                        </form>
                    </div>

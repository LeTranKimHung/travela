...
<head>
    ...
    <title>Sửa Tour - Travel Admin</title>
            ...
            <div class="col-md-9 col-lg-10 p-0 main-content">
                ...
                <nav class="navbar navbar-expand navbar-custom mb-4">
                    <div class="container-fluid">
                        ...
                        <h5 class="mb-0">Sửa Tour</h5>
                    </div>
                </nav>
                <div class="p-4">
                <h2 class="mb-4">Chỉnh sửa Tour: {{ $tour->title }}</h2>
                        ...
                        <form action="{{ route('admin.tours.update', $tour->tourId) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <textarea name="description" id="descriptionEditor" class="form-control" rows="4" required>{{ $tour->description }}</textarea>
                                </div>
                                <div class="col-md-12 mb-3">
                                    ...
                                    <div class="d-flex flex-wrap gap-2 mb-3">
                                        @foreach($images as $img)
                                            <div class="position-relative">
                                                <img src="{{ asset('clients/img/galery-tour/' . $img->imageURL) }}" alt="tour image" style="width: 80px; height: 80px; object-fit: cover; border-radius: 8px;">
                                            </div>
                                        @endforeach
                                    </div>
                                    <label class="form-label">Thêm ảnh mới (Tối đa 10 ảnh)</label>

...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h4 class="fw-bold mb-0">Tạo bài viết mới</h4>
        ...
        <form action="{{ route('admin.posts.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" name="author" class="form-control" placeholder="Tên tác giả (Để trống nếu là Admin)" value="{{ old('author') }}">
                </div>
                <div class="col-12">
                    <label class="form-label fw-semibold">Tóm tắt (Mô tả ngắn)</label>
                    <textarea name="summary" id="summaryEditor" class="form-control" rows="3"></textarea>
                </div>
                <div class="col-12">
